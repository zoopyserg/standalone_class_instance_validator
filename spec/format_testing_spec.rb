require '../fixtures/my_format_testing_class'

RSpec.describe MyFormatTestingClass do
  let(:instance) do
    item = MyFormatTestingClass.new
  ...
  context ':format parameter is present' do
    context 'attribute has no values' do
      ...
      it { expect{ instance.class_validate! }.to raise_error("attribute can correspond to required format") }
    end
